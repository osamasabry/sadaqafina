...
<head>
   ...
   <link rel='stylesheet' href='/Admin/bootstrap/css/bootstrap.rtl.css' type='text/css' />
    <!-- Font Awesome -->
    ...
    <link rel='stylesheet' href='/Admin/dist/css/AdminLTE.rtl.css' type='text/css' />
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="user-footer">
                    ...
                    @if((isset(Auth::user()->id)) and Auth::user()->user_type_id  == 1)
                      <a href="{{ route('user_infos.show',isset(Auth::user()->id ))}}" class="btn btn-default btn-flat">Profile</a>
                    @elseif((isset(Auth::user()->id)) and Auth::user()->user_type_id  == 2)
                      <a href="{{ route('charities.show',Auth::user()->charity->id )}}" class="btn btn-default btn-flat">Profile</a>
                    @else
                      <a href="{{ route('user_infos.show',isset(Auth::user()->id ))}}" class="btn btn-default btn-flat">Profile</a>
                    @endif
                    </div>
